...
REGISTER_SYSTEM_EX( "zm_custom_magicbox", &__init__, &__main__, undefined )

function __init__()
{
	clientfield::register( "zbarrier", "custom_zbarrier_show_sounds", VERSION_SHIP, 1, "counter" );
	clientfield::register( "zbarrier", "custom_zbarrier_leave_sounds", VERSION_SHIP, 1, "counter" );
	level.custom_magicbox_float_height 	= 40;
	level.custom_joker_movement = &default_custom_joker_movement;
...
function default_show_box( b_hide )
{
	...
	if ( isDefined( level.a_box_classnames[ str_classname ] ) && isDefined( level.a_box_classnames[ str_classname ].custom_show_box ) )
	{
		self.zbarrier clientfield::set( "magicbox_open_glow", 0 );
		self.zbarrier clientfield::set( "magicbox_closed_glow", 0 );

		self [ [ level.a_box_classnames[ str_classname ].custom_show_box ] ]( b_hide );
		return;
	}
	if ( !b_hide )
...
function default_magic_box_timer_til_despawn( s_magic_box )
{
	...
	if ( isDefined( level.a_box_classnames[ str_classname ] ) && isDefined( level.a_box_classnames[ str_classname ].custom_magic_box_timer_til_despawn ) )
	{
		self [ [ level.a_box_classnames[ str_classname ].custom_magic_box_timer_til_despawn ] ]( s_magic_box );
		return;
	}
...
{	
	str_classname = self.zbarrier.classname;
	if ( isDefined( level.a_box_classnames[ str_classname ] ) && isDefined( level.a_box_classnames[ str_classname ].custom_pandora_show_func ) )
	{
		self [ [ level.a_box_classnames[ str_classname ].custom_pandora_show_func ] ]( e_anchor, e_anchor_target, a_pieces );
...
{
	str_classname = self.zbarrier.classname;
	if ( isDefined( level.a_box_classnames[ str_classname ] ) && isDefined( level.a_box_classnames[ str_classname ].custom_pandora_fx_func ) )
	{
		self [ [ level.a_box_classnames[ str_classname ].custom_pandora_fx_func ] ]();
		return;
	}
	self zm_magicbox::default_pandora_fx_func();
}

function default_custom_joker_movement()
{
	str_classname = self.classname;
	if ( isDefined( level.a_box_classnames[ str_classname ] ) && isDefined( level.a_box_classnames[ str_classname ].custom_joker_custom_movement ) )
	{
		self [ [ level.a_box_classnames[ str_classname ].custom_joker_custom_movement ] ]();
		return;
	}
...
{
	str_classname = self.classname;
	if ( isDefined( level.a_box_classnames[ str_classname ] ) && isDefined( level.a_box_classnames[ str_classname ].custom_chest_glowfx ) )
	{
		self [ [ level.a_box_classnames[ str_classname ].custom_chest_glowfx ] ]();
		return;
	}
...
{
	str_classname = self.classname;
	if ( isDefined( level.a_box_classnames[ str_classname ] ) && isDefined( level.a_box_classnames[ str_classname ].custom_process_magic_box_zbarrier_state ) )
	{
		self [ [ level.a_box_classnames[ str_classname ].custom_process_magic_box_zbarrier_state ] ]( str_state );
		return;
	}
...
{
	str_classname = self.classname;
	if ( isDefined( level.a_box_classnames[ str_classname ] ) && isDefined( level.a_box_classnames[ str_classname ].custom_magic_box_do_weapon_rise ) )
	{
		self [ [ level.a_box_classnames[ str_classname ].custom_magic_box_do_weapon_rise ] ]();
		return;
	}
